...
const AdminConsole: React.FC<AdminConsoleProps> = ({
 ...
 {/* Table */}
 <div className="bg-black/3 border border-black/10 rounded-2xl overflow-hidden">
 ...
 <tbody className="divide-y divide-black/8 text-xs">
 {filteredParticipants.map(p => (
 <tr key={p.id} className="hover:bg-black/5 transition-all">
 ...
 className="p-2 bg-black/5 hover:bg-[#1552ab]/10 border border-black/10 hover:border-[#1552ab] text-[#1552ab] rounded-lg transition-all disabled:opacity-40"
 >
 {resendingId === p.id
