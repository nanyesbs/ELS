...
const RegistrationForm: React.FC<RegistrationFormProps> = ({ mode, token, initialData, onComplete }) => {
 ...
 <div className="absolute top-5 left-10 right-10 h-[2px] bg-white bg-[#efefef]/10 -z-10 rounded-full" />
 </div>
 </div>

 <div className="bg-black/5 border border-black/10 rounded-3xl p-6 sm:p-10 md:p-12 relative overflow-hidden backdrop-blur-2xl">
 ...
 <div className="flex flex-col sm:flex-row gap-6 items-center bg-black/3 p-6 rounded-2xl border border-black/8">
 <div className="relative w-24 h-24 rounded-full border border-black/10 bg-[#efefef]/40 overflow-hidden flex items-center justify-center shadow-inner shrink-0 group">
 {previewUrl ? (
 ...
 {/* Navigation buttons */}
 <div className="flex justify-between items-center pt-8 border-t border-black/8">
 {step > 1 ? (
 <button
 ...
 className="px-6 py-4 bg-black/5 border border-[#1552ab]/20 hover:border-[#1552ab] hover:bg-[#1552ab] text-[#1552ab] hover:text-white rounded-xl font-avenir-bold uppercase text-[10px] tracking-[3px] transition-all flex items-center gap-2"
 >
